...
#ifndef MICROCHIP_MCHP_PINCTRL_PINMUX_H_
#define MICROCHIP_MCHP_PINCTRL_PINMUX_H_
...
#define MCHP_PINMUX(port, pin_num, pin_mux, func)                                                  \
	((((MCHP_PINMUX_PORT_##port) & MCHP_PINMUX_PORT_MSK) << MCHP_PINMUX_PORT_POS) |            \
	 ...
	 (((MCHP_PINMUX_PERIPH_##pin_mux) & MCHP_PINMUX_PERIPH_MSK) << MCHP_PINMUX_PERIPH_POS))
 ...
 */
#define MCHP_PINMUX_GET(pincfg) (((pincfg) >> MCHP_PINCTRL_PINMUX_POS) & MCHP_PINCTRL_PINMUX_MASK)

#define MCHP_PINMUX_PORT_GET(pincfg)                                                               \
	((MCHP_PINMUX_GET(pincfg) >> MCHP_PINMUX_PORT_POS) & MCHP_PINMUX_PORT_MSK)

#define MCHP_PINMUX_PIN_GET(pincfg)                                                                \
	((MCHP_PINMUX_GET(pincfg) >> MCHP_PINMUX_PIN_POS) & MCHP_PINMUX_PIN_MSK)

#define MCHP_PINMUX_FUNC_GET(pincfg)                                                               \
	((MCHP_PINMUX_GET(pincfg) >> MCHP_PINMUX_FUNC_POS) & MCHP_PINMUX_FUNC_MSK)

#define MCHP_PINMUX_PERIPH_GET(pincfg)                                                             \
	((MCHP_PINMUX_GET(pincfg) >> MCHP_PINMUX_PERIPH_POS) & MCHP_PINMUX_PERIPH_MSK)

#endif /* MICROCHIP_MCHP_PINCTRL_PINMUX_H_ */
