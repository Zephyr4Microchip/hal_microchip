...
#define SAM_PINMUX(port, pin_num, pin_mux, func)                                                   \
	((((SAM_PINMUX_PORT_##port) & SAM_PINMUX_PORT_MSK) << SAM_PINMUX_PORT_POS) |               \
	 (((pin_num) & SAM_PINMUX_PIN_MSK) << SAM_PINMUX_PIN_POS) |                                \
	 (((SAM_PINMUX_FUNC_##func) & SAM_PINMUX_FUNC_MSK) << SAM_PINMUX_FUNC_POS) |               \
	 (((SAM_PINMUX_PERIPH_##pin_mux) & SAM_PINMUX_PERIPH_MSK) << SAM_PINMUX_PERIPH_POS))
 ...
 */
#define SAM_PINMUX_GET(pincfg) (((pincfg) >> SAM_PINCTRL_PINMUX_POS) & SAM_PINCTRL_PINMUX_MASK)

#define SAM_PINMUX_PORT_GET(pincfg)                                                                \
	((SAM_PINMUX_GET(pincfg) >> SAM_PINMUX_PORT_POS) & SAM_PINMUX_PORT_MSK)

#define SAM_PINMUX_PIN_GET(pincfg)                                                                 \
	((SAM_PINMUX_GET(pincfg) >> SAM_PINMUX_PIN_POS) & SAM_PINMUX_PIN_MSK)

#define SAM_PINMUX_FUNC_GET(pincfg)                                                                \
	((SAM_PINMUX_GET(pincfg) >> SAM_PINMUX_FUNC_POS) & SAM_PINMUX_FUNC_MSK)
