...
#ifndef INCLUDE_DT_BINDINGS_SAM_COMMON_MCHP_PINCTRL_PINMUX_SAM_H_
#define INCLUDE_DT_BINDINGS_SAM_COMMON_MCHP_PINCTRL_PINMUX_SAM_H_
...
#endif /* INCLUDE_DT_BINDINGS_SAM_COMMON_MCHP_PINCTRL_PINMUX_SAM_H_ */
