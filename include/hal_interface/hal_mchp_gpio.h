...
/**
 * @brief Set GPIO pin direction to input/output.
 *
 * This function sets the direction of a specified GPIO pin to input output.
 *
 * @param regs Pointer to the GPIO port register structure.
...
/**
 * @brief Get the input pins of a GPIO port.
 *
 * This function retrieves the current input pin states of the specified GPIO port.
 *
 * @param regs Pointer to the GPIO port register structure.
 * @return uint32_t Bitmask representing the input pin states of the GPIO port.
 */
static inline uint32_t hal_mchp_gpio_port_get_input_pins(hal_gpio_port_reg *regs);
/**
 * @brief Get the output pins of a GPIO port.
 *
 * This function retrieves the current output pin states of the specified GPIO port.
 *
 * @param regs Pointer to the GPIO port register structure.
 * @return uint32_t Bitmask representing the output pin states of the GPIO port.
 */
...
/**
 * @brief Disconnects a GPIO pin.
 *
 * This function disconnects the specified GPIO pin by modifying the
 * corresponding registers.
 *
 * @param regs Pointer to the GPIO port registers.
 * @param pin The pin number to be disconnected.
 * @retval 0 If successful
 * @retval HAL_MCHP_GPIO_ERR_NOTSUP if the feature is not supported
 */
